...
class NeuralNetworkModel:
    ...
    def train_model(self, epochs=600):
        self.history = self.model.fit(self.X_train_scaled, self.y_train, epochs=epochs, validation_split=0.2, verbose=0)
    ...
    def modify_and_train_new_model(self, new_layers, epochs=500):
        ...
        modified_history = modified_model.fit(self.X_train_scaled, self.y_train, epochs=epochs, validation_split=0.2, verbose=0)
...
if __name__ == "__main__":
    ...
    nn_model.modify_and_train_new_model([5, 3])
